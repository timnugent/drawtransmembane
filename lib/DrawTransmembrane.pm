...
sub new {
	...
	my $self = {
		...
		'short_loop' => exists $options{-short_loop_height} ? $options{-short_loop_height} : 90,
		'medium_loop' => exists $options{-medium_loop_height} ? $options{-medium_loop_height} : 120,
		'long_loop' => exists $options{-long_loop_height} ? $options{-long_loop_height} : 150,
		'short_loop_limit' => exists $options{-short_loop_limit} ? $options{-short_loop_limit} : 15,
		'long_loop_limit' => exists $options{-long_loop_limit} ? $options{-long_loop_limit} : 30,
